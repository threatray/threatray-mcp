    ...
    def _specs(self) -> list[ToolSpec]:
        ...
        return [
            ...
            ToolSpec("threatray_get_capa", {"file_hash": SHA256, "trigger_if_missing": False},
                     ...
                     {"capabilities": {"rules": {}}}),
            ToolSpec("threatray_get_capa_job", {"job_id": ANALYSIS_ID},
                     "GET", re.escape(f"{API_BASE}/v1/capa-analysis/jobs/{ANALYSIS_ID}"),
                     {"job_id": ANALYSIS_ID, "file_hash": SHA256, "job_status": "DONE"}),
